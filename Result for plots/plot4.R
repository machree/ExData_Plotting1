...
plot(hpcdata$Date, hpcdata$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(hpcdata$Date, hpcdata$Global_reactive_power,type="l",xlab="datetime",ylab="Global Reactive Power")
